...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("compute_sigma_image_cuda",
        &compute_sigma_image_cuda,
        "compute sigma image CUDA");
  m.def("compute_sigma_image_backward_cuda",
