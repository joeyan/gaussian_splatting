...
UV_GRAD_TRHRESHOLD = 0.0005  # paper = 0.0002

USE_FRACTIONAL_DENSIFICATION = False  # False to match paper
UV_GRAD_PERCENTILE = 0.92
SCALE_NORM_PERCENTILE = 1.0  # 1.0 to match paper

USE_SPLIT = True
USE_CLONE = True
USE_DELETE = True
ADAPTIVE_CONTROL_START = 1500
ADAPTIVE_CONTROL_END = 25000
ADAPTIVE_CONTROL_INVERVAL = 100

RESET_OPACITY_INTERVAL = 3050
RESET_OPACITY_VALUE = 0.1
RESET_OPACTIY_START = 1050
RESET_OPACITY_END = 6000
...
TEST_EVAL_INTERVAL = 50000

# DEBUG OPTIONS
SAVE_DEBUG_IMAGE_INTERVAL = 50000
PRINT_INTERVAL = 50
